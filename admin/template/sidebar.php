      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a><img src="assets/img/user/" class="img-circle" width="100" height="110"></a></p>
                  ...
                  <li class="sub-menu">
                      <a href="javascript:;" >
                          <i class="fa fa-desktop"></i>
                          <span>Supplier<span style="padding-left:2px;"> <i class="fa fa-angle-down"></i></span></span>
                      </a>
                      <ul class="sub">
                          <li><a  href="index.php?page=laporan">Supplier</a></li>
                      </ul>
                  </li>
